/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 63bdb6ba5b9f33f3d55c5cd2e0a6b4db)
// Runtime types generated with workerd@1.20260708.1 2026-06-12 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	ENVIRONMENT: "development";
	OPENAI_PROVIDER_MODE: "chat";
	UPSTREAM_CIRCUIT_BREAKER: DurableObjectNamespace<import("./src/worker/index").UpstreamCircuitBreaker>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "UpstreamCircuitBreaker";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "OPENAI_PROVIDER_MODE">> {}
}
